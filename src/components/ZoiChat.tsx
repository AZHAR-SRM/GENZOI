  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "Hey, I'm **ZOI** — your research-podcast sidekick. Ask me to explain a concept, summarize a paper, or suggest your next episode. ✨",
    },
  ]);
          ...
          >
            ...
            <div className="px-4 py-3 border-b border-border flex items-center gap-3 bg-gradient-to-r from-primary/15 to-transparent">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-muted-foreground">Personal research assistant</div>
              </div>
              <button
            ...
            <div className="border-t border-border p-3 bg-background/40">
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  rows={1}
                  placeholder="Ask ZOI anything about your paper…"
